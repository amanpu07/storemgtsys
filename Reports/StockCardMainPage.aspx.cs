...
public partial class Reports_StockCardMainPage : System.Web.UI.Page
{
    #region Variables
    ...
    protected void btnproceed_Click(object sender, EventArgs e)
    {
        ...
        {
            txtstore.Text = Session["StoreName"].ToString();
            Response.Redirect("StockCardRpt.aspx?itemcode=" + dditemname.SelectedValue + "&store=" + txtstore.Text + "&status=" + ddstatus.SelectedItem.Text);
            //Response.Redirect("StockCardRptPage.aspx?itemtype=" + dditemtype.SelectedItem.Text + "&itemname=" + dditemname.SelectedItem.Text + "&store=" + txtstore.Text);
        }
    }
