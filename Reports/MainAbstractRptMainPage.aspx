<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/StoreAE.master" AutoEventWireup="true" CodeFile="MainAbstractRptMainPage.aspx.cs" Inherits="Reports_MainAbstractRptMainPage" %>
        ...
        <table style="width: 100%; border-style: solid; border-width: 1px">
         <tr class="gridHeader" id="row1" runat="server">
                  <td align="left" colspan="6" 
                      style="border: thin solid #C0C0C0; text-align: left;">Main Abstract</td>
                  </tr>
                   <tr>
            ...
            <tr>
                <td style="border: thin solid #C0C0C0; text-align: right; font-family: Arial;">
                   &nbsp;&nbsp;
                    &nbsp; Item Name</td>
                <td style="border: thin solid #C0C0C0; text-align: left">
                    <asp:DropDownList ID="ddtype" runat="server" Height="23px" Width="119px" 
