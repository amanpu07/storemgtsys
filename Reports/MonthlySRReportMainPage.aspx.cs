...
public partial class Reports_MonthlySRReportMainPage : System.Web.UI.Page
{
    ...
    {       
        ...
        Response.Redirect("SRMonthlyReport.aspx?from=" + strfrom + "&to=" + strto + "&store=" + txtstore.Text);// + "&str=" + txtstore.Text);
    }
}