<%@ Page Language="C#" MasterPageFile="~/Inventory/StoreAE.master" AutoEventWireup="true" CodeFile="GRPageReport.aspx.cs" Inherits="Reports_GRPageReport" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
        Font-Size="8pt" Height="847px" Width="750px">
        <LocalReport ReportPath="RDLC2008\GoodsReceiptNote.rdlc">
            <DataSources>
