<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/StoreJE.master" AutoEventWireup="true" CodeFile="StoreJESRW.aspx.cs" Inherits="Inventory_StoreJESRW" %>
...
<table align="center" border="1" cellpadding="2" cellspacing="2" class="text3" width="100%">
        <tr class="gridHeader" id="r1" runat="server">
            <td align="left" style="height: 20px; width: 723px;"><b>SRW &nbsp;&nbsp; 
                <asp:Label
        ...
        <tr class="tableinnertext" id="gv" runat="server">
                    ...
                    ondatabound="GVInfo_DataBound" onsorting="GVInfo_Sorting">
                     <Columns>
                      <%-- <asp:ButtonField CommandName="Edit"  ItemStyle-HorizontalAlign="center"  HeaderStyle-CssClass="gridHeader"
                             HeaderText="Select" Text="Select"  ButtonType="Image" ImageUrl="~/images/edit.gif" />--%>
                             ...
                             HeaderText="Select" Text="Select"  ButtonType="Image" ImageUrl="~/images/sel.png" />
                                        ...
                                        <asp:TemplateField HeaderText="Sub Divison" SortExpression="subdiv">
                            <ItemTemplate><%#Eval("subdiv")%></ItemTemplate>
            ...
            <tr id="can" runat="server" class="tableinnertext" visible="false">
 ...
 <tr  class="tableinnertext" id="Tr23" runat="server">
      ...
      <tr class="tableinnertext" id="row5" runat="server">
            ...
            <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold;" align="left" width="200px">
              ...
              align="left">
                    Qty Value<asp:RequiredFieldValidator ID="RequiredFieldValidator22" 
        ...
        <table align="center" border="1" cellpadding="2" cellspacing="2" class="text3" width="100%" >
            ...
            <tr  class="tableinnertext" id="row9" runat="server">
                <td style="height: 25px; text-align: center;" align="center" colspan="2" >
                    <asp:Button ID="Proceed" runat="server" CssClass="btn" Visible="false"
                        OnClick="btnProceed_Click"  Text="Save" Width="63px" />&nbsp;&nbsp;
                                         
                        <asp:Button ID="btnclear" runat="server" CssClass="btn" Visible="false"
                        ...
                        CausesValidation="False" />&nbsp;&nbsp;                     
                        <asp:Button ID="btndel" runat="server" CssClass="btn" Visible="false"
