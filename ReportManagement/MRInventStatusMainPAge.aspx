<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/Management.master" AutoEventWireup="true" CodeFile="MRInventStatusMainPAge.aspx.cs" Inherits="ReportManagement_MRInventStatusMainPAge" %>
        ...
        <table style="width: 100%; border-style: solid; border-width: 1px">
         <tr class="gridHeader" id="row1" runat="server">
                  <td align="left" colspan="6" 
                      style="border: thin solid #C0C0C0; text-align: left;">MR-Inventory Status</td>
                  </tr>
            <tr>
