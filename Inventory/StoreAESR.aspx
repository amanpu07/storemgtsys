<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/StoreAE.master" AutoEventWireup="true" CodeFile="StoreAESR.aspx.cs" Inherits="Inventory_StoreAESR" %>
                     ...
                     <Columns>
                      <asp:ButtonField CommandName="Select"  ItemStyle-HorizontalAlign="center"  HeaderStyle-CssClass="gridHeader"
                            ...
                            <%--<HeaderStyle HorizontalAlign="Center" />--%>
                                                   ...
                                                   <asp:TemplateField HeaderText="SR No/Date" SortExpression="srchallanpageno">
                            <ItemTemplate><%#Eval("srchallanpageno")%>/<%#Eval("srchallanbookno")%><br> </br><%#Eval("srchallandate","{0:dd-MM-yy}")%></ItemTemplate>
                            <HeaderStyle CssClass="gridHeader"  />
                        ...
                        <asp:TemplateField HeaderText="Item Name" SortExpression="stockitemname">
                         ...
                         <asp:TemplateField HeaderText="Quantity Indented" SortExpression="qtyindented">
                          ...
                          <asp:TemplateField HeaderText="Quantity Issued" SortExpression="issuedqty">
                            <ItemTemplate><%#Eval("issuedqty")%></ItemTemplate>
                            <HeaderStyle CssClass="gridHeader"  />
                             <ItemStyle HorizontalAlign="Right"/>
                        ...
                        <asp:TemplateField HeaderText="Status" SortExpression="ifield2">
                            <ItemTemplate>
  ...
  <tr class="gridHeader" id="Tr2" runat="server">
       ...
       <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 144px;" 
              align="left">
                    ...
                    <td style="height: 5px; text-align: left; width: 123px;">
                   <asp:TextBox ID="txtissuedqty" runat="server" CssClass="combotext" Width="150px" AutoPostBack="false" ReadOnly="True"></asp:TextBox>
          </td>
            <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold;" align="left" width="200px">
                    Value per Item</td>
                <td style="text-align: left; height: 25px; width: 118px;">
                     <asp:TextBox ID="txtissuedvalue" runat="server" CssClass="combotext" 
                         Width="118px" AutoPostBack="false" ReadOnly="True"></asp:TextBox>
                    </td>
                <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 135px;" 
              align="left">
                    Total Value</td>
       ...
       <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 144px;" 
              align="left">
                    ...
                    <td  style="height: 5px; text-align: left; width: 123px;">
                     <asp:TextBox ID="txtstorage" runat="server" CssClass="combotext" AutoPostBack="false" 
                           Width="150px" ReadOnly="True" ></asp:TextBox>
                            </td>
            <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold;" align="left" width="200px">
                    Grand Total </td>
