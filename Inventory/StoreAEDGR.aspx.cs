...
public partial class Inventory_StoreAEDGR : System.Web.UI.Page
{
    static long i;
    ...
    private void gridbind()
    {
        string qry = string.Format("SELECT rtxno,grpageno,grbookno,grdate,itemname,unit,qtyaccepted,field2 FROM stockreceipttable " +
                                    "where field7=2 and smonth='DGR' and storename='{0}' " +
    ...
    protected void btsearch_Click(object sender, EventArgs e)
    {
        ...
        if (txtserbook.Text == "" || txtserpage.Text == "")
        {
            ...
            qry = string.Format("SELECT rtxno,grpageno,grbookno,grdate,itemname,unit,qtyaccepted,field2 FROM stockreceipttable " +
    ...
    {
        Response.Redirect("StoreAEDGR.aspx");
    }
    protected void btnapproval_Click(object sender, EventArgs e)
    {
        ...
        scmdText += string.Format(" UPDATE stockreceipttable SET field2='{0}' " +
                                 " WHERE  rtxno={1} and grbookno = {2} and grpageno = {3} "
                                  , "OK", i, Convert.ToInt32(txtgrno.Text), Convert.ToInt32(txtgrpageno.Text));
        scmdText += " END ";
    ...
    protected void GVDGR_DataBound(object sender, EventArgs e)
    {
        for (int i = 0; i <= GVDGR.Rows.Count - 1; i++)
        {
            ...
            {
                GVDGR.Rows[i].Cells[5].BackColor = System.Drawing.Color.Green;
                lblstatus.ForeColor = System.Drawing.Color.White;
            }
        }
    }
    ...
    protected void GVDGR_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        ...
        txtbox.Visible = true;
        long k;
        k = Convert.ToInt32(GVDGR.DataKeys[e.NewSelectedIndex].Value);
        i = Convert.ToInt32(GVDGR.DataKeys[e.NewSelectedIndex].Value);
        DataSet ds;
