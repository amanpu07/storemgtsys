<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/Subdivison.master" AutoEventWireup="true" CodeFile="testSR.aspx.cs" Inherits="Inventory_testSR" %>
    ...
    <table align="center" border="1" cellpadding="2" cellspacing="2" class="text3" width="100%">
       ...
       <tr  class="tableinnertext" id="Tr20" runat="server" visible="false">
              ...
              <tr  class="tableinnertext" id="Tr6" runat="server">
                ...
                <td colspan="10"  style="height: 10px; text-align: left;">
                    <b>
                    <asp:TextBox ID="txtsrdate" runat="server" CssClass="combotext" onblur="DoWaterMarkOnBlur(this,'dd-mm-yyyy')" onfocus="DoWaterMarkOnFocus(this,'dd-mm-yyyy')" Text="dd-mm-yyyy" Width="150px"></asp:TextBox>
                    </b></td>
               </tr>
