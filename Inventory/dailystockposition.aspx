<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/MPIndex13.master" AutoEventWireup="true" CodeFile="dailystockposition.aspx.cs" Inherits="Inventory_dailystockposition" %>
...
<script type="text/javascript" language="javascript">
   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <table align="center" border="1" cellpadding="2" cellspacing="2" class="text3" width="100%">
        <tr class="gridHeader" id="r1" runat="server">
            <td align="left" colspan="6" style="height: 20px; width: 723px;"><b>Daily Stores Stock Position
                </b></td>
        </tr>
 ...
 <tr  class="tableinnertext" id="Tr8" runat="server" visible="false">
        ...
        <tr class="tableinnertext" id="view" runat="server">
            <td align="left" colspan="6" style="height: 18px; width: 723px;">
