...
public partial class Inventory_StoreAEGR : System.Web.UI.Page
{
    static long i;
    ...
    private void gridbind()
    {
        string qry = string.Format("SELECT rtxno,grpageno,grbookno,grdate,itemname,unit,grandtotal,field2 FROM stockreceipttable " +
                                    "where field7=2 and smonth='GRFirm' and storename='{0}' and grbookno != 100000 " +
 ...
 if (ds.Tables[0].Rows[0]["field2"].ToString() == "OK")
    ...
    protected void btsearch_Click(object sender, EventArgs e)
    {
        ...
        if (txtserbook.Text == "" || txtserpage.Text == "")
        {
             ...
             qry = string.Format("SELECT rtxno,grpageno,grbookno,grdate,itemname,unit,grandtotal,field2 FROM stockreceipttable " +
    ...
    {
        Response.Redirect("StoreAEGR.aspx");
    }
