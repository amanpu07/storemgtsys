<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/StoreJE.master" AutoEventWireup="true" CodeFile="StoreJEJVDebit.aspx.cs" Inherits="Inventory_StoreJEJVDebit" %>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
                     ...
                     <Columns>
                       <asp:ButtonField CommandName="Edit"  ItemStyle-HorizontalAlign="center"  HeaderStyle-CssClass="gridHeader"
                            ...
                            <%--<HeaderStyle HorizontalAlign="Center" />--%>
                             ...
                             <ItemTemplate><%#Eval("datevoucher", "{0:dd-MM-yyyy}")%></ItemTemplate>
                            <HeaderStyle CssClass="gridHeader"  />
                            <ItemStyle HorizontalAlign="center"/>
                        ...
                        <asp:TemplateField HeaderText="Debit Amount" SortExpression="grandtotal">
       ...
       <tr  class="tableinnertext" id="Tr19" runat="server">
             ...
             <tr  class="tableinnertext" id="row2" runat="server">
                <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 200px;" 
                     align="left" >
                    SR/Challan Book No.&nbsp; <asp:RequiredFieldValidator 
                        ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter SR/Challan Book No." 
              ...
              <tr class="tableinnertext" id="Tr13" runat="server">
                <td class="tblrowcss" align="left" style="width: 200px" >
                    SR/Challan Page No. <asp:RequiredFieldValidator 
                        ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter SR/Challan Page No." 
             ...
             <tr  class="tableinnertext" id="Tr1" runat="server">
                <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 200px;" 
                     align="left">
                   SR/Challan Date&nbsp; <asp:RequiredFieldValidator 
                        ID="RequiredFieldValidator8" runat="server" ErrorMessage="Enter SR/Challan Date" 
               ...
               <tr  class="tableinnertext" id="Tr18" runat="server">
                ...
                <td style="height: 10px; text-align: left;">
                   <asp:DropDownList ID="ddstore" runat="server" Height="20px" Width="400px">
                                        <asp:ListItem Selected="True" Value="0">....</asp:ListItem>                     
                    </asp:DropDownList>&nbsp;<asp:Label ID="Label6" runat="server" ForeColor="Red" 
                            Text="*"></asp:Label></td>
               </tr>
