<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/Subdivison.master" AutoEventWireup="true" CodeFile="SubdivisonEstimateMaster.aspx.cs" Inherits="Inventory_SubdivisonEstimateMaster" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <script type="text/javascript">
     function validate() {
         if (document.getElementById("<%=txtestimate.ClientID%>").value == "") {
             alert("Estimate can not be blank");
             document.getElementById("<%=txtestimate.ClientID%>").focus();
             return false;
         }
         else {
             return true;
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    ...
    <table align="center" border="1" cellpadding="2" cellspacing="2" class="text3" width="100%">
        <tr class="gridHeader" id="Tr1" runat="server">
            <td align="left" style="height: 20px; width: 723px;"><b>Estimate Master
                <asp:Label
        ...
        <tr class="tableinnertext" id="gv" runat="server">
            <td align="center" style="width: 100%">
               ...
               <asp:GridView ID="GVInfo" runat="server"  CssClass="gridtext" 
                    ...
                    DataKeyNames="estid" AllowPaging="True" PageSize="50" 
                     ...
                     <Columns>
                       ...
                       <asp:ButtonField CommandName="Edit"  ItemStyle-HorizontalAlign="center"  HeaderStyle-CssClass="gridHeader"
                            ...
                            <%--<HeaderStyle HorizontalAlign="Center" />--%>
                                                ...
                                                <asp:TemplateField HeaderText="Estimate" SortExpression="estimate">
        ...
        <asp:Button ID="btnAddNew" runat="server" CssClass="btn" OnClick="btnAddNew_Click" 
                Text= "Add New Estimate" Width="154px" CausesValidation="False" />
    ...
    <table align="center" border="1" cellpadding="2" cellspacing="2" class="text3" width="100%">
        <tr class="gridHeader" id="r1" runat="server">
            <td align="left" colspan="6" style="height: 20px; width: 723px;"><b>Add Estimate 
          ...
          <tr  class="tableinnertext" id="Tr20" runat="server">
                ...
                <td colspan="5"  style="height: 10px; text-align: left;">
                   <asp:DropDownList ID="ddline" runat="server" Height="20px" Width="500px" AutoPostBack="True"
                        onselectedindexchanged="ddline_SelectedIndexChanged">
                                        <asp:ListItem Selected="True" Value="0">....</asp:ListItem>                     
                    </asp:DropDownList>&nbsp;<asp:CheckBox ID="CheckBox1" runat="server" 
                        AutoPostBack="True" Font-Bold="True" ForeColor="Red" 
                        oncheckedchanged="CheckBox1_CheckedChanged" Text="Click for Unsanctioned Estimate" />
                </td>
               </tr>   
        <tr class="tableinnertext" id="Tr3" runat="server"> 
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                        ControlToValidate="txtestimate" ErrorMessage="Enter Estimate" 
                        ForeColor="#FF0066">*</asp:RequiredFieldValidator>
                        </td>
                    <td colspan="5" style="height: 1px"> 
                        <asp:TextBox ID="txtestimate" runat="server" CssClass="combotext" Width="200px"></asp:TextBox>
        ...
        <tr class="tableinnertext" id="Tr4" runat="server"> 
                    ...
                    <td colspan="5" style="height: 1px"> 
                        <asp:TextBox ID="txtempid" runat="server" CssClass="combotext" Width="150px" 
            ...
            <tr  class="tableinnertext" id="row9" runat="server">
                <td style="height: 25px; text-align: center;" align="center" colspan="2" >
                    <asp:Button ID="Proceed" runat="server" CssClass="btn" 
                        OnClick="btnProceed_Click"  Text="Save" Width="70px" />&nbsp;
                   &nbsp;
                    <asp:Button ID="btnCancel2" runat="server" CssClass="btn" 
                        ...
                        OnClick="btnclear_Click" Text="Click for New Estimate" Width="150px" 
                        CausesValidation="False" />&nbsp;&nbsp;                        
