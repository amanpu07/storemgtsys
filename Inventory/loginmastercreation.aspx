<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/MPIndex11.master" AutoEventWireup="true" CodeFile="loginmastercreation.aspx.cs" Inherits="Inventory_loginmastercreation" %>
...
<table align="center" border="1" cellpadding="2" cellspacing="2" class="text3" width="100%">
        ...
        <tr  class="tableinnertext" id="Tr13" runat="server">
                <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 100px;" 
                     align="left">
                      Name of Sub Divison&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                        ControlToValidate="txtsubdiv" ErrorMessage="Enter Sub Divison" 
                        ForeColor="#FF0066">*</asp:RequiredFieldValidator></td>
                <td style="height: 10px; text-align: left;">
                    <asp:TextBox ID="txtsubdiv" runat="server" CssClass="combotext" Width="400px"></asp:TextBox>
                    &nbsp;</td>
               </tr>
               ...
               <tr  class="tableinnertext" id="Tr15" runat="server">
                ...
                <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 100px;" 
                     align="left">
                      User Name (SDO)&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ...
                <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 100px;" 
                     align="left">
                      Password (SDO)&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
...
--%>
        ...
        <asp:Button ID="btnAddNew" runat="server" CssClass="btn" OnClick="btnAddNew_Click" 
                Text= "Add New Login Details" Width="154px" CausesValidation="False" />
