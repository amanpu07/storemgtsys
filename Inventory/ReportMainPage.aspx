<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/StoreAE.master" AutoEventWireup="true" CodeFile="ReportMainPage.aspx.cs" Inherits="Inventory_ReportMainPage" %>
    ...
    <div id="nav_menu2">
                ...
                <li id="menu6"><a href="../Reports/RptJVCreditDebitMainPage.aspx"><span>JV-Credit/Debit</span></a></li>
                 <li id="menu7"><a href="../Reports/RptWrkWiseMainPage.aspx"><span>Work Wise Report</span></a></li>   
                  <li id="menu8"><a href="../HTML/InventoryMaster.xls"><span>Excel</span></a></li>   
