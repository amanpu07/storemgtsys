<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/Subdivison.master" AutoEventWireup="true" CodeFile="SubdivisonSRW.aspx.cs" Inherits="Inventory_SubdivisonSRW" %>
...
<table align="center" border="1" cellpadding="2" cellspacing="2" class="text3" width="100%">
        ...
        <asp:Button ID="btnAddNew" runat="server" CssClass="btn" OnClick="btnAddNew_Click" 
                Text= "Add New SRW" Width="154px" CausesValidation="False" />
        ...
        <tr   runat="server" id="txtbox" width="100%">
         ...
         <table align="center" border="1" cellpadding="2" cellspacing="2" class="text3" width="100%">
              ...
              <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 200px;" 
                       align="left">
                       SRW No.<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
               ControlToValidate="txtsrwno" ErrorMessage="Enter SRW No." 
              ...
              <tr class="tableinnertext" id="Tr17" runat="server">
               <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 200px;" 
                      align="left">
                        Date of SRW&nbsp; <asp:RequiredFieldValidator 
                        ID="RequiredFieldValidator8" runat="server" ErrorMessage="Enter SRW Date" 
                        ForeColor="#FF0066" ControlToValidate="txtsrwdate">*</asp:RequiredFieldValidator>
                  &nbsp; <asp:CompareValidator ID="CompareValidator1" runat="server" 
                        ControlToValidate="txtsrwdate" ErrorMessage="Enter Date" ForeColor="Red" 
...
<tr  class="tableinnertext" id="Tr20" runat="server">
              ...
              <tr  class="tableinnertext" id="Tr7" runat="server">
                ...
                <td style="height: 10px; text-align: left;">
                    <asp:DropDownList ID="ddestimate" runat="server" Height="23px" Width="200px" AutoPostBack="True"
      ...
      <tr class="tableinnertext" id="Tr1" runat="server"> 
            ...
            <tr class="tableinnertext" id="Tr10" runat="server"> 
                    <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 144px;" 
                        align="left">
                        SR No &amp; Date against which materila has drawn<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
               ControlToValidate="txtsrno" ErrorMessage="Enter SR No." 
               ForeColor="#FF0066">*</asp:RequiredFieldValidator></td>
                    <td colspan="5"> 
                            <asp:TextBox ID="txtsrno" runat="server" CssClass="combotext"  Width="200px"></asp:TextBox>
                 ...
                 <tr class="tableinnertext" id="Tr5" runat="server"> 
                    <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 144px;" 
                        align="left">
                        Reason for return the material<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
               ControlToValidate="txtremarks" ErrorMessage="Enter SRW No." 
               ForeColor="#FF0066">*</asp:RequiredFieldValidator></td>
                    <td colspan="5"> 
            ...
            <tr  class="tableinnertext" id="row9" runat="server">
                <td style="height: 25px; text-align: center;" align="center" colspan="2" >
                    ...
                    <asp:Button ID="btnCancel2" runat="server" CssClass="btn" 
                        ...
                        OnClick="btnclear_Click" Text="Click for New SRW" Width="150px" 
                        CausesValidation="False" />&nbsp;&nbsp;                        
