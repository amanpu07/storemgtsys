<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory/StoreJE.master" AutoEventWireup="true" CodeFile="StoreJEDGR.aspx.cs" Inherits="Inventory_StoreJEDGR" %>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    ...
    <table align="center" border="1" cellpadding="2" cellspacing="2" class="text3" width="100%">
        <tr class="gridHeader" id="r1" runat="server">
            <td align="left" colspan="6" style="height: 20px; width: 723px;"><b>DGR-Form
                <asp:Label
        ...
        <tr class="tableinnertext" id="gv" runat="server">
            <td align="center" colspan="6" style="width: 100%">
               ...
               <asp:GridView ID="GVDGR" runat="server"  CssClass="gridtext" 
                    ...
                    OnPageIndexChanging="GVDGR_PageIndexChanging" OnSorting="GVDGR_Sorting" Width="100%" 
                    DataKeyNames="rtxno" AllowPaging="True" PageSize="50" 
                    onrowcommand="GVDGR_EditClick" ondatabound="GVDGR_DataBound" 
                    onrowediting="GVDGR_RowEditing">
                     <Columns>
        ...
        <asp:Button ID="btnAddNew" runat="server" CssClass="btn" OnClick="btnAddNew_Click" 
                Text= "Add New DGR Item" Width="154px" CausesValidation="False" />
         ...
         <table align="center" border="1" cellpadding="2" cellspacing="2" class="text3" width="100%">
             ...
             <tr  class="tableinnertext" id="row2" runat="server">
                <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 200px;" 
                     align="left" >
                    DGR No.&nbsp; <asp:RequiredFieldValidator 
                        ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter DGR No." 
              ...
              <tr class="tableinnertext" id="Tr13" runat="server">
                <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 200px;" 
                     align="left">
                    DGR Page No. <asp:RequiredFieldValidator 
                        ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter DGR Page No." 
             ...
             <tr  class="tableinnertext" id="Tr1" runat="server">
                <td style="height: 10px; font-family: Arial; font-size: 8pt; font-weight: bold; width: 200px;" 
                     align="left">
                   DGR Date&nbsp; <asp:RequiredFieldValidator 
                        ID="RequiredFieldValidator8" runat="server" ErrorMessage="Enter DGR Date" 
       ...
       <table align="center" border="1" cellpadding="2" cellspacing="2" class="text3" width="100%" >
               ...
               <tr class="tableinnertext" id="row4" runat="server"> 
                ...
                <tr class="tableinnertext" id="Tr5" runat="server"> 
                  ...
                  <asp:TextBox ID="txtqty" runat="server" CssClass="combotext" onkeypress="return AcceptNumericOnly(event,true,this);"  Width="119px"></asp:TextBox>
                  &nbsp;
                     </td>
                </tr>
            ...
            <tr  class="tableinnertext" id="row9" runat="server">
                <td style="height: 25px; text-align: center;" align="center" colspan="6" >
                    ...
                    <asp:Button ID="btnCancel2" runat="server" CssClass="btn" 
                        ...
                        OnClick="btnclear_Click" Text="Click for New DGR" Width="150px" 
                        CausesValidation="False" />&nbsp;&nbsp;                        
